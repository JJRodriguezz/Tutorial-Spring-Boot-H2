...
public class Nota {
    ...
    public Nota(String titulo, String contenido, String tipoNota, Paciente paciente, Nutricionista nutricionista) {
        this.titulo = titulo;
    ...
    // Método para asignar automáticamente la fecha de creación antes de persistir
    @PrePersist
